...
import { resetStudentPasswordFirstStep } from "@/actions/auth";
...
const ResetStudentPasswordForm = () => {
  ...
  const onSubmit = async (values: z.infer<typeof ResetPasswordSchema>) => {
    ...
    if (values.username && values.phone) {
      const { error } = await resetStudentPasswordFirstStep({
  ...
  if (codeSent) {
    return (
      <ResetStudentPasswordVerificationForm
...
export default ResetStudentPasswordForm;
