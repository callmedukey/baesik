...
import { resetSchoolPasswordSecondStep, resetStudentPasswordSecondStep } from "@/actions/auth";

const ResetSchoolPasswordVerificationForm = ({
  username,
}: {
  username: string;
}) => {
  ...
  const onSubmitCode = async (
    ...
    const { error, redirectTo } = await resetSchoolPasswordSecondStep({
      code: values.code,
      username,
    });
...
export default ResetSchoolPasswordVerificationForm;
